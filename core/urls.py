...
#########################  Accounts New ######################
    ...
    re_path(r'^account_accounts/$', views.account_accounts,
            name='account_accounts'),
    re_path(r'^imagechange_accounts/$', views.imagechange_accounts, name='imagechange_accounts'),
    re_path(r'^changepassword_accounts/$', views.changepassword_accounts,
            name='changepassword_accounts'),
...
#     re_path(r'^acct_payment/(?P<id>\d+)$',views.acct_payment,name="acct_payment"),
